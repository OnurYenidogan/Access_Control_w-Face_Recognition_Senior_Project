...
def add_to_database(name,Kamera_Tipi):
    ...
    cur.execute("INSERT INTO your_table_name (name, datetime, Eylem) VALUES (%s, %s, %s)", (name, current_time), Kamera_Tipi)
    conn.commit()
